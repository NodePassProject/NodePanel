...
import { nodeTypes } from './NodeRenderer'; // Import nodeTypes from its new location

const initialZoomLevel = 0.5; // Adjusted initial zoom, was complex calculation
  ...
  return (
    ...
    >
      <ReactFlow
        ...
        nodeOrigin={[0, 0]}
        nodeTypes={nodeTypes} // Use imported nodeTypes
      >
